...
```{r}
# Now we can check out the results from this analysis. #resultNames and results are DEseq2 functions
resultsNames(dds)
...
Writting out useful files
```{r}

write.csv(res_df,"/scratch/Shares/rinnclass/JR/CLASS_2021/analysis/05_RNA_Seq/results/res_df.csv")

write.csv(samplesheet, "/scratch/Shares/rinnclass/JR/CLASS_2021/analysis/05_RNA_Seq/results/samplesheet.csv")
...
#lfcShrink shrinks log fold change based on certainty (so low expression get's accounted for)
...
write_csv(res_df, "/scratch/Shares/rinnclass/JR/CLASS_2021/analysis/05_RNA_Seq/results/deseq_unshrnk_results.csv")

write_csv(res_shrunken_df, "/scratch/Shares/rinnclass/JR/CLASS_2021/analysis/05_RNA_Seq/results/deseq_shrnk_results.csv")
