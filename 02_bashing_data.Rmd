...
```
awk -F $"/t" '{print $6}' data/encode_awk_lessons.tsv | wc -l
...
TODO debug
```
awk -F "/t" '{print $7}' encode_awk_lessons.tsv > dbp.tsv
```
...
awk --field-separator="\t" "{print NF}" data/encode_awk_lessons.tsv
```
