...
bump1_promoters <- filter(peak_occurrence_df, peak_occurrence_df$number_of_dbp < 50)
bump1_promoters <- filter(peak_occurrence_df, peak_occurrence_df$number_of_dbp > 0)

bump2_promoters <- filter(peak_occurrence_df, peak_occurrence_df$number_of_dbp > 250)
bump2_promoters <- filter(bump2_promoters, peak_occurrence_df$number_of_dbp < 350)
```
