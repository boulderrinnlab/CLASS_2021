...
promoter_df <- bind_rows(HEPG2_promoter_df, k562_promoter_df) %>%
  ...
  write_csv("results/promoter_dbp_map.csv")
...
# Import annotations
lncrna_mrna_promoters <- rtracklayer::import("results/lncrna_mrna_promoters.gtf")
lncrna_mrna_genebody <- rtracklayer::import("results/lncrna_mrna_genebody.gtf")
