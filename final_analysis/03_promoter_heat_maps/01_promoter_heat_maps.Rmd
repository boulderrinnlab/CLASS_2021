...
ZNF280B_promoter <- all_promoters_gr[all_promoters_gr$gene_name == "ZNF280B"]
ZNF280B_promoter_matrix <- make_promoter_binding_matrix(consensus_peaks, ZNF280B_promoter)
plot_promoter_peak_matrix(ZNF280B_promoter_matrix, gene_name = "ZNF280B", save_pdf = TRUE)
```