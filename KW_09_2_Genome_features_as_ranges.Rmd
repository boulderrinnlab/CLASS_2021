...
#to be able to look at the gr as a data frame:
gencode_df <- gencode_gr %>% as.data.frame() #but you can't use gr comands like intersect in the data frame format

#if you View(gencode_gr) then hover over the thing you're interested in and click the arrow icon to the right then it will show how to index that layer
...
```{r}
#what % of the largets gene (RBFOX1) is exonic?
