...
source("/scratch/Shares/rinnclass/Olivia/CLASS_2021/util/intersect_functions.R")
```

```{r}


filtered_consensus_peaks_files <- list.files("/scratch/Shares/rinnclass/Olivia/CLASS_2021/analysis/00_consensus_peaks/results/chipseq/filtered_consensus", 
                                             pattern = "*.bed",
                                             full.names = TRUE)
filtered_consensus_peaks <- lapply(filtered_consensus_peaks_files, rtracklayer::import)

names(filtered_consensus_peaks) <- gsub("/scratch/Shares/rinnclass/Olivia/CLASS_2021/analysis/00_consensus_peaks/results/chipseq/filtered_consensus/|_filtered_consensus_peaks.bed", "", filtered_consensus_peaks_files)

# Import annotations
lncrna_mrna_promoters <- rtracklayer::import("/scratch/Shares/rinnclass/Olivia/CLASS_2021/analysis/00_consensus_peaks/results/chipseq/promoters/lncrna_mrna_promoters.gtf")
lncrna_mrna_genebody <- rtracklayer::import("/scratch/Shares/rinnclass/Olivia/CLASS_2021/analysis/00_consensus_peaks/results/chipseq/gene_body/lncrna_mrna_genebody.gtf")
...
write_csv(num_peaks_df, "/scratch/Shares/rinnclass/Olivia/CLASS_2021/analysis/01_global_peak_properties/results/num_peaks_df.csv")
```
...
write_csv(peak_occurence_df, "/scratch/Shares/rinnclass/Olivia/CLASS_2021/analysis/01_global_peak_properties/results/peak_occurence_dataframe.csv")
```
