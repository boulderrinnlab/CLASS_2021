...
xargs will ultimately be invoked to skip empty lines.
...
Enough let's run it -- NOTE these files are large so make sure you are working
...
paste in the two md5sums from the ENCODE website --- with two spaces ----, ctrl x and enter now we have a
file with two md5sums.
