...
column_to_rownames(peaks_per_dbp, var = "dbp")
...
# mutate(peaks_per_dbp, tpl_m = total_peak_length / 1000000)
...
ifelse(peaks_per_dbp$tpl_m < 50, "small",ifelse(tpl_m < 60, "medium", "large"))
