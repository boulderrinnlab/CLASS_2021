...
for (i in 1:length(consensus_peaks)) {
  rtracklayer::export(consensus_peaks[[i]],paste0("/scratch/Shares/rinnclass/Nina/CLASS_2021/results/consensus_peaks/", names(consensus_peaks)[i],"_consensus_peaks.bed"))
}
