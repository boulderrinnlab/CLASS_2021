...
```
<<<<<<< HEAD
#util folder can hold functions that you can call in analysis

=======

 
>>>>>>> cb5307452be4b98426453633c044b9b1fad9ab0d
...
<<<<<<< HEAD
  ...
  fl <- fl[1:20]
  #REMOVE THE ABOVE LINE TO RUN FOR THE FULL DATA SET
  ...
  tf_name <- sapply(fl, function(x){
    #function is how you make an anonymous function to use for a subset of commands
    #sapply lets you apply a function over a list, above we're feeding in the fl list and our function to pull out the sample/DBP name
