...
#add column of resevoirs shared in both cell lines

promoter_features_df$shared_resevoir <- as.numeric(promoter_features_df$hepg2_reservoir == 1 & promoter_features_df$k562_reservoir == 1)
