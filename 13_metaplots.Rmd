...
# Plot the dendrogram
pdf("/scratch/Shares/rinnclass/Nina/CLASS_2021/figures/tss_profile_dendrogram.pdf", height = 10, width = 27)
par(cex=0.3)
plot(metaplot_hclust)
dev.off()

# Cut the tree to make some clusters
clusters <- cutree(metaplot_hclust, h = 1) # cut at dendogram; smaller high more clusters, 
table(clusters)

clust2 <- mm_scaled[clusters ==2,]
dim(clust2)
...
pdf("/scratch/Shares/rinnclass/Nina/CLASS_2021/figures/tss_profile_heatmap_16.pdf", height = 35, width = 10)
