...
# Number 391
for(i in 392:length(consensus_peaks)) {
...
passing_peaks <- names(consensus_peaks)[which(sapply(consensus_peaks, length) > 250)]

# Let's cluster the metaplots df. First we need to turn it into a matrix.
metaplot_df <- read_csv("../../data/metaplot_df.csv") %>%
