...
# Import annotations
lncrna_mrna_promoters <- rtracklayer::import("/scratch/Shares/rinnclass/tardigrades/CLASS_2021/analysis/00_consensus_peaks/results/genebody/lncrna_mrna_promoters.gtf")
...
# Make Data Frame: DBP & Number of Genes Bound
...
write_csv(unbound_promoters, "/scratch/Shares/rinnclass/tardigrades/CLASS_2021/analysis/01_global_peak_properties/results/unbound_lncrna_mrna_promoters.csv")
```
...
Dive deeper into genes with num of DBPs >= 300
```{r}
high_dense_genes <- peak_occurence_df %>% filter(peak_occurence_df$number_of_dbp >= 300)
