...
```{r}
filtered_consensus_peaks_files <- list.files("/scratch/Shares/rinnclass/Katy/CLASS_2021/analysis/00_consensus_peaks/results/filtered_consensus/", 
                                             pattern = "*.bed",
                                             full.names = TRUE)
...
lncrna_mrna_genebody <- rtracklayer::import("/scratch/Shares/rinnclass/Katy/CLASS_2021/analysis/00_consensus_peaks/results/lncrna_mrna_genebody.gtf")
...
write_csv(num_peaks_df, "/scratch/Shares/rinnclass/Katy/CLASS_2021/analysis/01_global_peak_properties/results/num_peaks_df.csv")
```
...
write.table(promoter_peak_occurence, "/scratch/Shares/rinnclass/Katy/CLASS_2021/analysis/01_global_peak_properties/results/lncrna_mrna_promoter_peak_occurence_matrix.tsv")
...
write_csv(peak_occurence_df, "/scratch/Shares/rinnclass/Katy/CLASS_2021/analysis/01_global_peak_properties/results/peak_occurence_dataframe.csv")
```
...
use read_csv() to read in saved csv files or right click in the file tab and import
