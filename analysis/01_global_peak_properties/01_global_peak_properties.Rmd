...
filtered_consensus_peaks_files <- list.files("/scratch/Shares/rinnclass/results/chipseq/filtered_consensus", 
                                             pattern = "*.bed",
                                             full.names = TRUE)
filtered_consensus_peaks <- lapply(filtered_consensus_peaks_files, rtracklayer::import)
filtered_consensus_peaks_files
names(filtered_consensus_peaks) <- gsub("/scratch/Shares/rinnclass/results/chipseq/filtered_consensus/|_filtered_consensus_peaks.bed", "", filtered_consensus_peaks_files)
