...
library(ggpubr)
source("/scratch/Shares/rinnclass/JR/CLASS_2021/util/intersect_functions.R")
source("/scratch/Shares/rinnclass/JR/CLASS_2021/util/_setup.R")
```
...
write_csv(samplesheet, "results/samplesheet_fix.csv")
```
...
ggsave("figures/binding_vs_expression_total.pdf")
```
