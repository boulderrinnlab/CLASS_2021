...
for(i in 1:length(consensus_peaks)) {
  rtracklayer::export(consensus_peaks[[i]], 
                      paste0("/scratch/Shares/rinnclass/Justin/CLASS_2021/analysis/00_consensus_peaks/results/consensus_peaks/", 
...
for(i in 1:length(filtered_consensus_peaks)) {
  rtracklayer::export(filtered_consensus_peaks[[i]], 
                      paste0("/scratch/Shares/rinnclass/Justin/CLASS_2021/analysis/00_consensus_peaks/results/filtered_consensus/", 
...
rtracklayer::export(lncrna_mrna_promoters, "/scratch/Shares/rinnclass/Justin/CLASS_2021/analysis/00_consensus_peaks/results/promoters/lncrna_mrna_promoters.gtf")


lncrna_promoters <- get_promoter_regions(gencode_gr, biotype = "lncRNA")

rtracklayer::export(lncrna_promoters, "/scratch/Shares/rinnclass/Justin/CLASS_2021/analysis/00_consensus_peaks/results/promoters/lncrna_promoters.gtf")


mrna_promoters <- get_promoter_regions(gencode_gr, biotype = "protein_coding")
rtracklayer::export(mrna_promoters, "/scratch/Shares/rinnclass/Justin/CLASS_2021/analysis/00_consensus_peaks/results/promoters/mrna_promoters.gtf")
```
...
rtracklayer::export(lncrna_mrna_genebody, "/scratch/Shares/rinnclass/Justin/CLASS_2021/analysis/00_consensus_peaks/results/genebody/lncrna_mrna_genebody.gtf")


lncrna_genebody <- gencode_gr[gencode_gr$type == "gene" & 
                                gencode_gr$gene_type %in% c("lncRNA")]
rtracklayer::export(lncrna_genebody, "/scratch/Shares/rinnclass/Justin/CLASS_2021/analysis/00_consensus_peaks/results/genebody/lncrna_genebody.gtf")


mrna_genebody <- gencode_gr[gencode_gr$type == "gene" & 
                              gencode_gr$gene_type %in% c("protein_coding")]
rtracklayer::export(mrna_genebody, "/scratch/Shares/rinnclass/Justin/CLASS_2021/analysis/00_consensus_peaks/results/genebody/mrna_genebody.gtf")
