...
gencode_gr <- rtracklayer::import("/Users/maca9088/CLASS/data/gencode.v32.annotation.gtf")
...
total_trans_length <- gencode_gr[gencode_gr$type == "transcript"] %>%
  GenomicRanges::reduce() %>% 
  width() %>%
  sum()
...
=======
pol2_chip <- rtracklayer::import("/scratch/Shares/rinnclass/data/POLR2A_consensus_peaks_filter.bed")
>>>>>>> origin/in_class
