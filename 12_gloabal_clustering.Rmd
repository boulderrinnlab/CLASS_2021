...
ATF5_promoters <- peak_occurence_matrix[rownames(peak_occurence_matrix) %in% c("ATF5","ZNF34"),]
...
FUBP3_promoters_high <- high_binders[rownames(high_binders) == "FUBP3",]
FUBP3_promoters_high <- FUBP3_promoters_high[colSums(FUBP3_promoters_high) == 1]

ATF5_FUBP3_promoters_high <- high_binders[rownames(high_binders) == "ATF5" "FUBP3"]
ATF5_promoters_high <- ATF5_promoters_high[colSums(ATF5_promoters_high) == 1]
ATF5_promoters_high <- as.data.frame(t(ATF5_promoters_high))

ATF5_promoters_high <- high_binders[rownames(high_binders) == "ZNF343",]
ATF5_promoters_high <- ATF5_promoters_high[colSums(ATF5_promoters_high) == 1]
ATF5_promoters_high <- as.data.frame(t(ATF5_promoters_high))
