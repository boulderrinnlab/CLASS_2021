...
peak_occurence_matrix <- read.table('/scratch/Shares/rinnclass/Nina/CLASS_2021/analysis/01_global_peak_properties/results/lncrna_mrna_promoter_peak_occurence_matrix.tsv')
...
zinc_finger_dbd <- num_peaks_df %>% filter(dbd == "C2H2 ZF", dbp %in% rownames(high_binders))
...
# do for whole peak_occurence_matrix
pheatmap(peak_occurence_matrix, clustering_distance_rows = "binary", clustering_distance_cols = "binary")
