...
pattern_to_search <- paste0(genes, collapse = 'l')
table(grepl(pattern_to_search, file$dbp))
ppdbp_subset <- file[grepl(pattern_to_search, file$dbp)]
file[1:3, 'id']

file <- file %>%
  column_to_rownames(var = 'dbp')
file['POLR2A', 'total_peak_length']
