...
abundant_dbds <- names(which(table(num_peaks_df$dbd) > 100))
#abundant_dbds
#most_abun_dbds <- names(which(abundant_dbds))

#Evolution of "C2H2 ZF"
...
temp <- table(num_peaks_df$dbd)[order(table(num_peaks_df$dbd), decreasing = T)]
