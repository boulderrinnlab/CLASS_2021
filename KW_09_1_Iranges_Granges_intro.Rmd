...
ov1 <- union(ir1, ir2) #union combines peaks like a sum
plotRanges(ov1)
ov1
...
ov3 <- intersect(ir1, ir2) #intersect only retains overlapping sections, in our analysis we look for overlaps and then go back and pull the summ of the peaks that overlapp but peaks that are next to eachother won't be combined where in union they would be
plotRanges(ov3)
