...
# Ok a bit better with gene names in ENSEMBLE ID which has a unique id for each
# transcript variant.
```
...
### Huh it looks the same -- notice there are 240K and 250K lncRNA and mRNA values.
