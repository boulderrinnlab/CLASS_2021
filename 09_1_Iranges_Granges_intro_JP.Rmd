...
# You don't need to store the labels for every single thing, RLE (run length encoding) is a list of how many times that label will appear - it takes up less memory in RAM. This is basically recycling the labels
seqinfo(gr)
